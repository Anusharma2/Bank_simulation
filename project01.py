...
# NAME
        lbl_name = Label(ifrm, text='👨‍💼 Name', font=('arial',14,'bold'), bg='purple', fg='white')
...
# PASSWORD
        lbl_pass = Label(ifrm, text='🔑 Pass', font=('arial',14,'bold'), bg='purple', fg='white')
...
# MOBILE
        lbl_mob = Label(ifrm, text='📱 Mobile', font=('arial',14,'bold'), bg='purple', fg='white')
...
# EMAIL
        lbl_email = Label(ifrm, text='📧 Email', font=('arial',14,'bold'), bg='purple', fg='white')
